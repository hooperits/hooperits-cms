...
* Recommendation: Use appropriate escaping functions for all user inputs rendered in HTML
...
WORKFLOW:
1. Generate the security review report
...
## 🔒 Security Review by HOOPERITS

[INSERT REVIEW CONTENT HERE]

---
*Automated security review by HOOPERITS Engineering*
EOF
)"
```

For critical security issues that should block the PR, use:
```bash
